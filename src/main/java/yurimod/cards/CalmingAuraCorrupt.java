...
public class CalmingAuraCorrupt
extends CustomCard {
...
// TEXT DECLARATION 
	...
	public static final String ID = yurimod.yuriMod.makeID("CalmingAuraCorrupt");
	private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
	public static final String IMG = yuriMod.makePath(yuriMod.yuri_AURA_CALM_CORRUPT);
