...
import yurimod.powers.DoubleCodePower;
...
// TEXT DECLARATION 
	...
	public static final String ID = yurimod.yuriMod.makeID("DuplicateCode");
	private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
	public static final String IMG = yuriMod.makePath(yuriMod.yuri_DOUBLE_CODE);
